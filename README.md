...
An app that allows the user to view and manage books and accounts for a local library.

Following content taken from requirements lists the functionality of the program.
